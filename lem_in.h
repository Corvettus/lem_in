...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/04 03:28:10 by tlynesse          #+#    #+#             */
/*   Updated: 2019/11/04 03:45:12 by tlynesse         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					path_push(t_path ***path, t_way *way,
int num, t_map *map);
...
int						check_overlap(t_way *way, t_map **map,
t_dijkstra *dijkstra);
...
void					lets_go(t_map *map, t_path *path,
int ants, t_path *begin);
...
void					lem(int fd);
void					dijkstra_util(int linked, int cur,
int i, t_dijkstra **dijkstra);
